...
def calculate_accuracy():
    ...
    # model.save('classical.h5')
    
    model_filename = 'svm_model2.joblib'
    ...
    #model.save('classical.h5')
    # from sklearn.externals import joblib
    # joblib.dump(model, 'classical.pkl')
...
image_path = r"C:\Users\Hazem\Desktop\Computer-Vision-main (1)\Computer-Vision-main\img2.jpeg"
